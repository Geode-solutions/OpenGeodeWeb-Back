...
class MissingFiles:
    ...
    def from_dict(obj: Any) -> 'MissingFiles':
        ...
        return MissingFiles(filename, input_geode_object)
...
def missing_files_from_dict(s: Any) -> MissingFiles:
    return MissingFiles.from_dict(s)


def missing_files_to_dict(x: MissingFiles) -> Any:
    return to_class(MissingFiles, x)
