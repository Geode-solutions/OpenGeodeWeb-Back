...
class SaveViewableFile:
    ...
    def from_dict(obj: Any) -> "SaveViewableFile":
        ...
        return SaveViewableFile(filename, input_geode_object)
...
def save_viewable_file_from_dict(s: Any) -> SaveViewableFile:
    return SaveViewableFile.from_dict(s)


def save_viewable_file_to_dict(x: SaveViewableFile) -> Any:
    return to_class(SaveViewableFile, x)
